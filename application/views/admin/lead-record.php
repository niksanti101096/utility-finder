            ...
            <div class="row">
                <div class="col-12 d-flex">
                    ...
                    <div class="ml-auto">
                        ...
                        <button type="button" class="btn mx-1 btn-warning">Edit</button>
                                ...
                                <div class="row" id="lead-details">
                                    ...
                                    <div class="col-12 d-flex justify-content-between">
                                        <div class="form-group row flex-fill">
                                            ...
                                            <div class="col-sm-2 d-flex align-items-center">
                                                <p class="col-form-label text-dark-white">Status</p>
                                            </div>
                                            <div class="col-sm-1 d-flex align-items-center">
                                                <p class="col-form-label text-dark-white" id="status"></p>
                                            </div>
